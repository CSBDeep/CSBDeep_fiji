 ...
 *
 */
public abstract class MyAbstractUnivariateStatistic< T extends RealType< T >> {
     ...
     * {@inheritDoc}
     */
    public abstract double evaluate(final IterableInterval<T> values);
...
//     * @since 3.0
//     */
//    protected boolean test(final IterableInterval<T> values, final int begin,
