...
// * <p>
// * Since 2.2, MyPercentile uses only selection instead of complete sorting
...
//
//    /** Stored data. */
//    private IterableInterval<T> storedData;
//
//    /**
...
//     */
//    protected IterableInterval<T> getDataRef() {
//        return storedData;
//    }
//
//    /** {@inheritDoc} */
//    public void setData(final IterableInterval<T> values) {
//        if (values == null) {
//            cachedPivots = null;
//        } else {
...
//     *     or p is invalid
//     */
//    public T evaluate(final IterableInterval<T> values, final double p)
//    throws MathIllegalArgumentException {
////        test(values, 0, 0);
...
//     *
//     */
//    public T evaluate(final IterableInterval<T> values, final int start, final int length)
//    throws MathIllegalArgumentException {
...
//     * input array is null
//     */
//    public T evaluate(final IterableInterval<T> values, final int begin,
...
//        }
//        if (length == 1) {
//            return values.firstElement(); // always return single value for n = 1
//        }
//
//        final IterableInterval<T> work = getWorkArray(values, begin, length);
//        final int[] pivotsHeap = getPivots(values);
//        return work.size() == 0 ? null :
...
//     * {@link MyPercentile} instances(thus indirectly {@link PivotingStrategy})
...
//     * and instead use {@link MyPercentile#withKthSelector(newKthSelector)} if
//     * required.
//     *
//     */
//    @Deprecated
//    int medianOf3(final IterableInterval<T> work, final int begin, final int end) {
...
//     * @param source MyPercentile to copy
//     * @param dest MyPercentile to copy to
...
//      */
//    @Deprecated
//    public static void copy(final MyPercentile source, final MyPercentile dest)
...
//     */
//    protected double[] getWorkArray(final IterableInterval<T> values, final int begin, final int length) {
//            final IterableInterval<T> work;
...
//     */
//    private static double[] copyOf(final IterableInterval<T> values, final int begin, final int length) {
...
//     */
//    private static double[] replaceAndSlice(final IterableInterval<T> values,
//                                            final int begin, final int length,
//                                            final double original,
//                                            final double replacement) {
//        final IterableInterval<T> temp = copyOf(values, begin, length);
...
//     */
//    private static double[] removeAndSlice(final IterableInterval<T> values,
//                                           final int begin, final int length,
//                                           final double removedValue) {
//        MathArrays.verifyValues(values, begin, length);
//        final IterableInterval<T> temp;
...
//     */
//    private int[] getPivots(final IterableInterval<T> values) {
...
//     * </p>
//     * <pre>
//     *   MyPercentile customized = new MyPercentile(quantile).
...
//     */
//    public MyPercentile withEstimationType(final EstimationType newEstimationType) {
//        return new MyPercentile(quantile, newEstimationType, nanStrategy, kthSelector);
//    }
//
//    /**
...
//     */
//    public MyPercentile withNaNStrategy(final NaNStrategy newNaNStrategy) {
//        return new MyPercentile(quantile, estimationType, newNaNStrategy, kthSelector);
//    }
//
//    /**
...
//     */
//    public MyPercentile withKthSelector(final KthSelector newKthSelector) {
//        return new MyPercentile(quantile, estimationType, nanStrategy,
//                                newKthSelector);
//    }
//
//    /**
...
//             */
//            @Override
//            protected double estimate(final IterableInterval<T> values,
...
//         */
//        protected double estimate(final IterableInterval<T> work, final int[] pivotsHeap,
...
//         */
//        protected T evaluate(final IterableInterval<T> work, final int[] pivotsHeap, final double p,
//                                  final KthSelector selector) {
...
//         * @throws NullArgumentException if work array is null
//         */
//        public T evaluate(final IterableInterval<T> work, final double p, final KthSelector selector) {
