...
public class NetProject< T extends RealType< T > > implements Command, Cancelable {
	...
	private final String modelfileUrl =
			"http://fly.mpi-cbg.de/~pietzsch/CSBDeep-data/net_project.zip";
	private final String modelName = "net_project";
	private final String modelfileName = "model_pro_avg.pb";
