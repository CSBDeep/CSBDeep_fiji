...
public class NetTribolium< T extends RealType< T > > implements Command, Cancelable {

	@Parameter( visibility = ItemVisibility.MESSAGE )
	private final String header = "This is the projection network command.";

	@Parameter( label = "input data", type = ItemIO.INPUT, initializer = "processDataset" )
	private Dataset input;

	private final String modelfileUrl =
			"http://fly.mpi-cbg.de/~pietzsch/CSBDeep-data/net_tribolium.zip";
	private final String modelName = "net_tribolium";
	private final String modelfileName = "model_resunet3_2_5_32.pb";
...
//		System.out.println("inputNodeNameChanged");
	...
	public void run() {
		...
		if ( bridge != null ) {
			...
			bridge.setMapping( 0, 4 );
			bridge.setMapping( 1, 3 );
			bridge.setMapping( 2, 1 );
			bridge.setMapping( 3, 0 );
			bridge.setMapping( 4, 2 );
		}
