...
public class NetTribolium<T extends RealType<T>> implements Command, Cancelable {
    ...
    private String modelfileUrl = "http://fly.mpi-cbg.de/~pietzsch/CSBDeep-data/net_tribolium.zip";
    private String modelName = "net_tribolium";
    private String modelfileName = "model_resunet3_2_5_32.pb";
